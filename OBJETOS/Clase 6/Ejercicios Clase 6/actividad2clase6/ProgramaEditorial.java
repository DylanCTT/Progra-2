...
public class ProgramaEditorial {
  public static void main(String [] args) {
    ...
    Ejemplar [] vecEjemplares = new Ejemplar[1000];
    ...
    for (int i=0;i<2;i++) {
      ...
      if (ejemplar.equals("libro")) {
        ...
        Ejemplar lib = new Libro(cod,cantPag,resumen,r,año,titulo,cantCap,esBolsillo);
        vecEjemplares[i] = lib;
      }
      ...
      if (ejemplar.equals("revista")) {
        ...
        cantArt = in.nextInt();
        Ejemplar rev = new Revista(cod,cantPag,año,resumen,r,numVol,nombre,cantArt);
        vecEjemplares[i] = rev;
      }
    }
    ...
    for (int j=0;j<2;j++) {
      vecEjemplares[j].Publicacion();
      System.out.println(vecEjemplares[j].toString());
    }
}
}